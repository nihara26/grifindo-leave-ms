...
namespace GrifindoLeaveMS {
    ...
    public partial class GrifindoLeaveMSDataSet2 : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeeRow AddEmployeeRow(string Name, string Password, System.DateTime DOB, string Address, string PhoneNo, System.DateTime JobStartDate) {
...
namespace GrifindoLeaveMS.GrifindoLeaveMSDataSet2TableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employee] WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Name] = @Original_Name) AND ([Password] = @Original_Password) AND ((@IsNull_DOB = 1 AND [DOB] IS NULL) OR ([DOB] = @Original_DOB)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_PhoneNo = 1 AND [PhoneNo] IS NULL) OR ([PhoneNo] = @Original_PhoneNo)) AND ((@IsNull_JobStartDate = 1 AND [JobStartDate] IS NULL) OR ([JobStartDate] = @Original_JobStartDate)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employee] ([Name], [Password], [DOB], [Address], [PhoneNo], [JobStartDate]) VALUES (@Name, @Password, @DOB, @Address, @PhoneNo, @JobStartDate);
SELECT EmployeeID, Name, Password, DOB, Address, PhoneNo, JobStartDate FROM Employee WHERE (EmployeeID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Name] = @Name, [Password] = @Password, [DOB] = @DOB, [Address] = @Address, [PhoneNo] = @PhoneNo, [JobStartDate] = @JobStartDate WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Name] = @Original_Name) AND ([Password] = @Original_Password) AND ((@IsNull_DOB = 1 AND [DOB] IS NULL) OR ([DOB] = @Original_DOB)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_PhoneNo = 1 AND [PhoneNo] IS NULL) OR ([PhoneNo] = @Original_PhoneNo)) AND ((@IsNull_JobStartDate = 1 AND [JobStartDate] IS NULL) OR ([JobStartDate] = @Original_JobStartDate)));
SELECT EmployeeID, Name, Password, DOB, Address, PhoneNo, JobStartDate FROM Employee WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, Name, Password, DOB, Address, PhoneNo, JobStartDate FROM dbo.E" +
                "mployee";
        ...
        public virtual int Fill(GrifindoLeaveMSDataSet2.EmployeeDataTable dataTable) {
        ...
        public virtual GrifindoLeaveMSDataSet2.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            GrifindoLeaveMSDataSet2.EmployeeDataTable dataTable = new GrifindoLeaveMSDataSet2.EmployeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(GrifindoLeaveMSDataSet2.EmployeeDataTable dataTable) {
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_Name, string Original_Password, global::System.Nullable<global::System.DateTime> Original_DOB, string Original_Address, string Original_PhoneNo, global::System.Nullable<global::System.DateTime> Original_JobStartDate) {
            ...
            if ((Original_JobStartDate.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[10].Value = ((System.DateTime)(Original_JobStartDate.Value));
            }
            else {
        ...
        public virtual int Insert(string Name, string Password, global::System.Nullable<global::System.DateTime> DOB, string Address, string PhoneNo, global::System.Nullable<global::System.DateTime> JobStartDate) {
            if ((Name == null)) {
            ...
            if ((JobStartDate.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[5].Value = ((System.DateTime)(JobStartDate.Value));
            }
            else {
        ...
        public virtual int Update(string Name, string Password, global::System.Nullable<global::System.DateTime> DOB, string Address, string PhoneNo, global::System.Nullable<global::System.DateTime> JobStartDate, int Original_EmployeeID, string Original_Name, string Original_Password, global::System.Nullable<global::System.DateTime> Original_DOB, string Original_Address, string Original_PhoneNo, global::System.Nullable<global::System.DateTime> Original_JobStartDate, int EmployeeID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            if ((JobStartDate.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((System.DateTime)(JobStartDate.Value));
            }
            else {
            ...
            if ((Original_JobStartDate.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((System.DateTime)(Original_JobStartDate.Value));
            }
            else {
        ...
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Password, global::System.Nullable<global::System.DateTime> DOB, string Address, string PhoneNo, global::System.Nullable<global::System.DateTime> JobStartDate, int Original_EmployeeID, string Original_Name, string Original_Password, global::System.Nullable<global::System.DateTime> Original_DOB, string Original_Address, string Original_PhoneNo, global::System.Nullable<global::System.DateTime> Original_JobStartDate) {
            return this.Update(Name, Password, DOB, Address, PhoneNo, JobStartDate, Original_EmployeeID, Original_Name, Original_Password, Original_DOB, Original_Address, Original_PhoneNo, Original_JobStartDate, Original_EmployeeID);
        }
    }
